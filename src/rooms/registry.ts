...
export const ROOM_CATALOG: readonly RoomMetadata[] = [
  ...
  // Room 23
  {
    ...
    backend: 'canvas2d',
    backendDisplay: 'CANVAS 2D / DLA',
    mathModel: 'Witten-Sander Model & Brownian Walk Spatial Aggregation',
    description: 'Fractal dendritic crystal branching generated by diffusion-limited aggregation of Brownian random-walking particles.',
    curatorialNote: 'Simulates the non-equilibrium physical growth process discovered by Witten and Sander (1981), where random-walking particles diffuse until sticking to a seed cluster, forming delicate fractal trees of dimension D ≈ 1.71 across iridescent obsidian gradients.',
    tags: ['dla', 'diffusion-limited-aggregation', 'fractal', 'dendritic', 'brownian-motion', 'crystal-growth', 'morphogenesis', 'witten-sander', 'coral', 'snow'],
    moods: ['crystalline', 'organic', 'delicate', 'hypnotic', 'intricate', 'meditative'],
    defaultParams: {
      seed: '#00FF9D',
    ...
    controls: [
      {
        ...
        type: 'select',
        options: [
          { label: 'Classic Dendrite (Snowflake Fractal)', value: 'classic-dendrite' },
          { label: 'Coral Reef (Dense Lichen / Eden)', value: 'coral-reef' },
          { label: 'Frost Spires (Vertical Stalagmites)', value: 'frost-spires' },
          { label: 'Concentric Nebula (Ring Seed In/Out)', value: 'concentric-nebula' },
          { label: 'Quad Colonies (4-Center Battle)', value: 'quad-colonies' },
          { label: 'Anisotropic Snow (6-Fold Hexagonal)', value: 'anisotropic-snow' },
        ],
        folder: 'Morphology & Presets',
      },
      {
        ...
        type: 'select',
        options: [
          { label: 'Single Point (Center Nucleus)', value: 'point' },
          { label: 'Baseline (Bottom Frost Ribbon)', value: 'line' },
          { label: 'Concentric Ring (Perimeter Seed)', value: 'ring' },
          { label: 'Quad Cardinal Points', value: 'quad' },
          { label: 'Hexagram (6 Snowflake Nuclei)', value: 'hexagram' },
        ],
        folder: 'Morphology & Presets',
      },
      { key: 'seedRadius', label: 'Seed Ring / Multi Radius', type: 'slider', min: 10, max: 200, step: 5, folder: 'Morphology & Presets' },

      { key: 'stickingProbability', label: 'Sticking Probability (p_s)', type: 'slider', min: 0.02, max: 1.0, step: 0.02, folder: 'Aggregation & Physics' },
      { key: 'particlesPerFrame', label: 'Particles / Frame', type: 'slider', min: 10, max: 500, step: 10, folder: 'Aggregation & Physics' },
      { key: 'activeWalkers', label: 'Active Brownian Walkers', type: 'slider', min: 100, max: 2000, step: 50, folder: 'Aggregation & Physics' },
      { key: 'maxParticles', label: 'Max Cluster Capacity', type: 'slider', min: 2000, max: 40000, step: 1000, folder: 'Aggregation & Physics' },
      { key: 'stepSize', label: 'Brownian Step Size', type: 'slider', min: 0.8, max: 4.0, step: 0.1, folder: 'Aggregation & Physics' },
      {
        key: 'anisotropy',
        label: 'Lattice Anisotropy',
        type: 'select',
        options: [
          { label: 'None (Isotropic Brownian)', value: 0 },
          { label: '4-Fold Tetragonal Lattice', value: 4 },
          { label: '6-Fold Hexagonal Snow', value: 6 },
        ],
        folder: 'Aggregation & Physics',
      },
      {
        key: 'driftDirection',
        ...
        type: 'select',
        options: [
          { label: 'None (Pure Diffusion)', value: 'none' },
          { label: 'Upward (Stalagmites / Frost)', value: 'up' },
          { label: 'Downward (Stalactites / Rain)', value: 'down' },
          { label: 'Inward (Radial Gravitation)', value: 'inward' },
          { label: 'Outward (Explosive Diffusion)', value: 'outward' },
          { label: 'Vortex (Swirling Pinwheel)', value: 'vortex' },
        ],
        folder: 'Aggregation & Physics',
      },
      { key: 'driftStrength', label: 'Drift Strength', type: 'slider', min: 0.0, max: 1.0, step: 0.05, folder: 'Aggregation & Physics' },

      {
        ...
        type: 'select',
        options: [
          { label: 'Dendritic Filaments (Connected)', value: 'dendritic-filaments' },
          { label: 'Glow Nodes (Circular Discs)', value: 'glow-nodes' },
          { label: 'Luminous Spores (Additive Halo)', value: 'luminous-spores' },
          { label: 'Crystalline Mesh (Faceted Ice)', value: 'crystalline-mesh' },
        ],
        folder: 'Crystal Styling & Rendering',
      },
      { key: 'branchThickness', label: 'Branch Thickness', type: 'slider', min: 0.5, max: 5.0, step: 0.1, folder: 'Crystal Styling & Rendering' },
      { key: 'particleRadius', label: 'Particle Node Radius', type: 'slider', min: 0.5, max: 5.0, step: 0.1, folder: 'Crystal Styling & Rendering' },
      { key: 'glowIntensity', label: 'Glow Intensity', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Crystal Styling & Rendering' },
      { key: 'tipGlow', label: 'Pulsing Tip Beacons', type: 'boolean', folder: 'Crystal Styling & Rendering' },

      {
        ...
        type: 'select',
        options: [
          { label: 'Iridescent Obsidian (Basalt / Mint)', value: 'iridescent-obsidian' },
          { label: 'Frost Crystal (Glacial Ice / Cyan)', value: 'frost-crystal' },
          { label: 'Solar Coral (Amber / Gold / Crimson)', value: 'solar-coral' },
          { label: 'Spectral Amethyst (Ultraviolet / Orchid)', value: 'spectral-amethyst' },
          { label: 'Bioluminescent Abyss (Emerald / Cyan)', value: 'bioluminescent-abyss' },
          { label: 'Monochrome Lithic (Slate / Silver)', value: 'monochrome-lithic' },
        ],
        folder: 'Color, Gradients & Cycles',
      },
      {
        key: 'colorMode',
        ...
        type: 'select',
        options: [
          { label: 'Branch Age (Growth Sequence)', value: 'branch-age' },
          { label: 'Radial Distance (Center to Edge)', value: 'distance-radial' },
          { label: 'Hierarchy Depth (Generations)', value: 'branch-hierarchy' },
          { label: 'Seed Colony (Multi-Center)', value: 'seed-colony' },
        ],
        folder: 'Color, Gradients & Cycles',
      },
      { key: 'paletteCycleSpeed', label: 'Palette Cycling Speed', type: 'slider', min: 0.0, max: 1.0, step: 0.05, folder: 'Color, Gradients & Cycles' },

      {
        ...
        type: 'select',
        options: [
          { label: 'Plant Seed Crystal (Click to Nucleate)', value: 'plant-seed' },
          { label: 'Electrostatic Attraction (Vacuum)', value: 'attract' },
          { label: 'Electrostatic Repulsion (Blow)', value: 'repel' },
          { label: 'Disabled / Observation', value: 'none' },
        ],
        folder: 'Pointer & Nucleation',
      },
      { key: 'pointerRadius', label: 'Pointer Field Radius', type: 'slider', min: 20, max: 250, step: 5, folder: 'Pointer & Nucleation' },
      { key: 'pointerStrength', label: 'Pointer Field Strength', type: 'slider', min: 0.1, max: 3.0, step: 0.1, folder: 'Pointer & Nucleation' },
      ...
      { key: 'audioSensitivity', label: 'Spectral Sensitivity', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Audio Reactivity' },
      { key: 'bassReaction', label: 'Bass Reaction (Aggregation Rate)', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Audio Reactivity' },
      { key: 'midReaction', label: 'Mid Reaction (Sticking Prob)', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Audio Reactivity' },
      { key: 'trebleReaction', label: 'Treble Reaction (Tip Glow)', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Audio Reactivity' },
    ],
  },
  ...
  // Room 24
  {
    ...
    index: 24,
    indexDisplay: '#24',
    name: "Dynamic Voronoi & Lloyd's Relaxation",
    category: 'morphogenesis',
    categoryName: 'Morphogenesis & Landscape',
    backend: 'webgl2',
    backendDisplay: 'WEBGL2 / VORONOI',
    mathModel: "Worley Distance Fields (F1, F2) & Lloyd Centroid Relaxation Dynamics",
    description: "Real-time animated cellular space partition mosaics with variable distance metrics (L1, L2, Lp, L∞) and Lloyd's relaxation dynamics.",
    curatorialNote: "Explores continuous geometric space partitioning and the morphogenetic transition from chaotic seed dispersion to optimal hexagonal soap foam packing through iterative Voronoi centroid relaxation and GPU distance field synthesis.",
    tags: ['voronoi', 'lloyd-relaxation', 'worley-noise', 'cellular-foam', 'distance-metrics', 'tessellation', 'morphogenesis', 'hexagonal-packing', 'f1-f2', 'shading'],
    moods: ['organic', 'hypnotic', 'geometric', 'crystalline', 'meditative', 'fluid'],
    defaultParams: {
      seed: '#00FF9D',
    ...
    controls: [
      {
        key: 'preset',
        label: 'Tessellation Preset',
        type: 'select',
        options: [
          { label: 'Hexagonal Foam (Soap Bubbles / Lloyd)', value: 'hexagonal-foam' },
          { label: 'Chaotic Drift (Dynamic Physics / Facets)', value: 'chaotic-drift' },
          { label: 'Manhattan Grid (L1 Diamond City)', value: 'manhattan-grid' },
          { label: 'Chebyshev Crystals (L∞ Square Boxes)', value: 'chebyshev-crystals' },
          { label: 'Minkowski Hyper (Lp Star Astroids)', value: 'minkowski-hyper' },
          { label: 'Worley Biotissue (Organic Membrane)', value: 'worley-biotissue' },
          { label: 'Quantum Lattice (F2 - F1 Wireframe)', value: 'quantum-lattice' },
        ],
        folder: 'Morphology & Presets',
      },
      { key: 'cellCount', label: 'Cell / Seed Count', type: 'slider', min: 16, max: 128, step: 1, folder: 'Morphology & Presets' },
      {
        key: 'distanceMetric',
        label: 'Distance Metric',
        type: 'select',
        options: [
          { label: 'Euclidean L2 (Standard Circles)', value: 'euclidean' },
          { label: 'Manhattan L1 (Diamond Rhombus)', value: 'manhattan' },
          { label: 'Chebyshev L∞ (Square Boxes)', value: 'chebyshev' },
          { label: 'Minkowski Lp (Generalized Power)', value: 'minkowski' },
        ],
        folder: 'Morphology & Presets',
      },
      { key: 'minkowskiP', label: 'Minkowski Power (p)', type: 'slider', min: 0.4, max: 4.0, step: 0.1, folder: 'Morphology & Presets' },
      {
        key: 'motionMode',
        label: 'Motion Dynamics',
        type: 'select',
        options: [
          { label: "Lloyd's Centroid Relaxation", value: 'lloyd-relaxation' },
          { label: 'Dynamic Velocity Physics', value: 'dynamic-physics' },
          { label: 'Cellular Organic Drift', value: 'cellular-drift' },
          { label: 'Orbital Vortex Swirl', value: 'vortex-swirl' },
          { label: 'Harmonic Radial Breathing', value: 'pulsating-breathing' },
        ],
        folder: 'Morphology & Presets',
      },
      { key: 'relaxationStrength', label: 'Lloyd Relaxation Rate', type: 'slider', min: 0.0, max: 1.0, step: 0.02, folder: 'Morphology & Presets' },

      {
        key: 'shadingMode',
        label: 'Visual Shading Style',
        type: 'select',
        options: [
          { label: 'Cellular Foam (Glowing Neon Walls)', value: 'cellular-foam' },
          { label: 'Crystal Facets (3D Beveled Prisms)', value: 'crystal-facets' },
          { label: 'Distance Field (Topographic Isolines)', value: 'distance-field' },
          { label: 'Worley Noise (Organic Density)', value: 'worley-noise' },
          { label: 'F2 - F1 Wireframe (Architectural Lattice)', value: 'f2-minus-f1' },
          { label: 'Voronoi Mosaic (Stained Glass Cells)', value: 'voronoi-mosaic' },
        ],
        folder: 'Shading & Aesthetics',
      },
      { key: 'borderThickness', label: 'Border Thickness', type: 'slider', min: 0.005, max: 0.15, step: 0.005, folder: 'Shading & Aesthetics' },
      { key: 'borderGlow', label: 'Border Neon Glow', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Shading & Aesthetics' },
      { key: 'borderSharpness', label: 'Border Sharpness', type: 'slider', min: 0.5, max: 5.0, step: 0.1, folder: 'Shading & Aesthetics' },
      { key: 'interiorGradient', label: 'Interior Fill Gradient', type: 'slider', min: 0.0, max: 2.0, step: 0.1, folder: 'Shading & Aesthetics' },
      { key: 'seedGlow', label: 'Seed Nucleus Glow', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Shading & Aesthetics' },
      { key: 'seedSize', label: 'Seed Nucleus Radius', type: 'slider', min: 0.002, max: 0.04, step: 0.002, folder: 'Shading & Aesthetics' },
      { key: 'isolineCount', label: 'Contour Isolines Count', type: 'slider', min: 2, max: 30, step: 1, folder: 'Shading & Aesthetics' },
      { key: 'facetBevel', label: 'Crystal Facet Bevel', type: 'slider', min: 0.2, max: 4.0, step: 0.1, folder: 'Shading & Aesthetics' },

      {
        ...
        options: [
          ...
          { label: 'Cyber Neon (Cobalt / Magenta)', value: 'cyber-neon' },
          { label: 'Cosmic Amethyst (Purple / Orchid)', value: 'cosmic-amethyst' },
          { label: 'Monochrome Lithic (Slate / Platinum)', value: 'monochrome-lithic' },
          { label: 'Bioluminescent Abyss (Marine / Phosphor)', value: 'bioluminescent-abyss' },
        ],
        folder: 'Color, Gradients & Cycles',
      },
      {
        ...
        type: 'select',
        options: [
          { label: 'Palette Gradient (Continuous Spatial)', value: 'palette-gradient' },
          { label: 'Cell ID (Discrete Palette Hash)', value: 'cell-id' },
          { label: 'Distance F1 (Nucleus Radial)', value: 'distance-f1' },
          { label: 'Boundary Proximity (F2 - F1 Field)', value: 'boundary-f2f1' },
        ],
        folder: 'Color, Gradients & Cycles',
      },
      { key: 'paletteCycleSpeed', label: 'Palette Phase Rate', type: 'slider', min: 0.0, max: 2.0, step: 0.05, folder: 'Color, Gradients & Cycles' },
      { key: 'contrast', label: 'Contrast', type: 'slider', min: 0.5, max: 3.0, step: 0.1, folder: 'Color, Gradients & Cycles' },
      { key: 'brightness', label: 'DC Brightness Bias', type: 'slider', min: -0.4, max: 0.4, step: 0.02, folder: 'Color, Gradients & Cycles' },

      { key: 'speed', label: 'Simulation Speed', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Kinematics & Forces' },
      { key: 'driftJitter', label: 'Brownian Drift Jitter', type: 'slider', min: 0.0, max: 2.0, step: 0.05, folder: 'Kinematics & Forces' },
      { key: 'wallBounce', label: 'Boundary Wall Bounce', type: 'boolean', folder: 'Kinematics & Forces' },
      { key: 'seedRepulsion', label: 'Seed-Seed Repulsion', type: 'slider', min: 0.0, max: 2.0, step: 0.1, folder: 'Kinematics & Forces' },
      { key: 'damping', label: 'Velocity Damping', type: 'slider', min: 0.90, max: 0.999, step: 0.005, folder: 'Kinematics & Forces' },

      {
        ...
        type: 'select',
        options: [
          { label: 'Interactive Seed (Cursor Carves Cell)', value: 'interactive-seed' },
          { label: 'Electrostatic Repulsion (Blow Seeds)', value: 'repel' },
          { label: 'Gravitational Attraction (Pull Seeds)', value: 'attract' },
          { label: 'Orbital Vortex (Swirl Seeds)', value: 'vortex' },
          { label: 'Disabled / Observation', value: 'none' },
        ],
        folder: 'Pointer Interaction',
      },
      { key: 'pointerRadius', label: 'Pointer Field Radius', type: 'slider', min: 0.05, max: 0.5, step: 0.02, folder: 'Pointer Interaction' },
      { key: 'pointerStrength', label: 'Pointer Field Force', type: 'slider', min: 0.1, max: 3.0, step: 0.1, folder: 'Pointer Interaction' },
      ...
      { key: 'audioSensitivity', label: 'Spectral Sensitivity', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Audio Reactivity' },
      { key: 'bassReaction', label: 'Bass Reaction (Border Pulsing)', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Audio Reactivity' },
      { key: 'midReaction', label: 'Mid Reaction (Relaxation / Drift)', type: 'slider', min: 0.0, max: 3.0, step: 0.1, folder: 'Audio Reactivity' },
  ...
  try {
    ...
    switch (id) {
      ...
      case 'tunnel-warp':
        ...
        break;
      case 'dla':
        modulePromise = import('./dla/index');
        break;
      case 'voronoi':
