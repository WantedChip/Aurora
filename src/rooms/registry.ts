...
export const ROOM_CATALOG: readonly RoomMetadata[] = [
  // Room 01
  {
    ...
    controls: [
      { key: 'particleCount', label: 'Particle Count', type: 'slider', min: 500, max: 8000, step: 100, folder: 'Simulation' },
      { key: 'noiseScale', label: 'Noise Frequency', type: 'slider', min: 0.0005, max: 0.01, step: 0.0005, folder: 'Field Dynamics' },
      { key: 'stepLength', label: 'Step Speed', type: 'slider', min: 0.5, max: 6.0, step: 0.1, folder: 'Field Dynamics' },
      { key: 'trailDecay', label: 'Fade Rate', type: 'slider', min: 0.01, max: 0.2, step: 0.01, folder: 'Aesthetics' },
      {
        key: 'colorPalette',
        label: 'Palette',
        type: 'select',
  ...
  // Room 02
  {
    ...
    controls: [
      ...
      { key: 'octaves', label: 'Octaves', type: 'slider', min: 1, max: 8, step: 1, folder: 'Warp Engine' },
  ...
  // Room 03
  {
    ...
    defaultParams: {
      ...
      alignmentWeight: 1.0,
      cohesionWeight: 1.2,
      predatorRepulsion: 3.0,
      maxSpeed: 4.0,
    },
    controls: [
      { key: 'boidCount', label: 'Flock Size', type: 'slider', min: 200, max: 4000, step: 100, folder: 'Flock' },
      { key: 'separationWeight', label: 'Separation', type: 'slider', min: 0.1, max: 4.0, step: 0.1, folder: 'Steering Weights' },
      { key: 'alignmentWeight', label: 'Alignment', type: 'slider', min: 0.1, max: 4.0, step: 0.1, folder: 'Steering Weights' },
      { key: 'cohesionWeight', label: 'Cohesion', type: 'slider', min: 0.1, max: 4.0, step: 0.1, folder: 'Steering Weights' },
      { key: 'predatorRepulsion', label: 'Cursor Fear', type: 'slider', min: 0.0, max: 8.0, step: 0.2, folder: 'Interaction' },
    ],
  },
  ...
  // Room 04
  {
    ...
    controls: [
      { key: 'agentCount', label: 'Agent Count', type: 'slider', min: 50000, max: 1000000, step: 50000, folder: 'Agents' },
      { key: 'sensorAngle', label: 'Sensor Angle', type: 'slider', min: 0.1, max: 1.2, step: 0.05, folder: 'Sensory Steering' },
      { key: 'sensorDistance', label: 'Sensor Range', type: 'slider', min: 4.0, max: 32.0, step: 1.0, folder: 'Sensory Steering' },
      { key: 'stepSize', label: 'Motor Step Size', type: 'slider', min: 0.5, max: 3.0, step: 0.1, folder: 'Agents' },
      { key: 'decayRate', label: 'Trail Decay', type: 'slider', min: 0.85, max: 0.99, step: 0.01, folder: 'Chemical Field' },
    ],
  },
  ...
  // Room 05
  {
    ...
    controls: [
      { key: 'particleCount', label: 'Particle Count', type: 'slider', min: 10000, max: 250000, step: 10000, folder: 'Universe' },
      { key: 'speciesCount', label: 'Species Count', type: 'slider', min: 3, max: 8, step: 1, folder: 'Universe' },
      { key: 'interactionRadius', label: 'Force Range', type: 'slider', min: 30.0, max: 180.0, step: 5.0, folder: 'Physics' },
      { key: 'friction', label: 'Drag Friction', type: 'slider', min: 0.01, max: 0.15, step: 0.01, folder: 'Physics' },
  ...
  // Room 06
  {
    ...
    controls: [
      { key: 'feedRate', label: 'Feed Rate (f)', type: 'slider', min: 0.01, max: 0.09, step: 0.001, folder: 'Gray-Scott Parameters' },
      { key: 'killRate', label: 'Kill Rate (k)', type: 'slider', min: 0.04, max: 0.07, step: 0.001, folder: 'Gray-Scott Parameters' },
      { key: 'simSpeed', label: 'Iterations / Frame', type: 'slider', min: 1, max: 16, step: 1, folder: 'Engine' },
    ],
  },
  ...
  // Room 07
  {
    ...
    controls: [
      { key: 'mu', label: 'Target Mean (μ)', type: 'slider', min: 0.05, max: 0.35, step: 0.005, folder: 'Growth Mapping' },
      { key: 'sigma', label: 'Bandwidth (σ)', type: 'slider', min: 0.005, max: 0.05, step: 0.002, folder: 'Growth Mapping' },
      { key: 'dt', label: 'Time Step (dt)', type: 'slider', min: 0.02, max: 0.25, step: 0.01, folder: 'Spacetime' },
      { key: 'kernelRadius', label: 'Kernel Radius', type: 'slider', min: 8, max: 24, step: 1, folder: 'Spacetime' },
    ],
  },
